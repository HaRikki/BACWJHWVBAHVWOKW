/** Official-style platform logos as SVG components */
...
export function IconTikTok({ className = "w-5 h-5", dark = false }: { className?: string; dark?: boolean }) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill={dark ? "#fff" : "#000"}>
      <path d="M19.59 6.69a4.83 4.83 0 01-3.77-4.25V2h-3.45v13.67a2.89 2.89 0 01-2.88 2.5 2.89 2.89 0 01-2.89-2.89 2.89 2.89 0 012.89-2.89c.28 0 .54.04.79.12v-3.4a6.22 6.22 0 00-.79-.05A6.33 6.33 0 003.16 15.2a6.33 6.33 0 006.33 6.33 6.33 6.33 0 006.33-6.33V9.21a8.16 8.16 0 004.77 1.52V7.28a4.84 4.84 0 01-1-.59z"/>
    </svg>
  );
}

export function IconTelegram({ className = "w-5 h-5" }: { className?: string }) {
  return (
...
export function IconAll({ className = "w-5 h-5" }: { className?: string }) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="none" stroke="#64748b" strokeWidth="2">
...
export function IconPlus({ className = "w-5 h-5" }: { className?: string }) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="none" stroke="#94a3b8" strokeWidth="2">
